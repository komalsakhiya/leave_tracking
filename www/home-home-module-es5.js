...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.presentAlert = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var date, finalDate, alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(data);
                        date = data.date;
                        finalDate = date.year + '/' + date.month + '/' + date.date;
...
var ReportsComponent = /** @class */ (function () {
    ...
    ReportsComponent.prototype.getYearLeaveReport = function (data) {
        ...
        this._leaveService.getYearLeaveReport(data).subscribe(function (res) {
            ...
            console.log("year report=======>", _this.yearLeaveReport);
        }, function (err) {
            console.log(err);
        });
    };
...
var SingleUsreComponent = /** @class */ (function () {
    ...
    SingleUsreComponent.prototype.getUserById = function (userId) {
        ...
        this._userService.getUserById(userId).subscribe(function (res) {
            ...
            _this.singleUser.dob = _this.singleUser.dob.split("T")[0];
...
var HomePage = /** @class */ (function () {
    function HomePage(router, _userService, menu, plt, fcm, _toastService, localNotifications) {
        var _this = this;
        this.router = router;
        this._userService = _userService;
        this.menu = menu;
...
var ProfilePage = /** @class */ (function () {
    function ProfilePage(modalController, _userService) {
